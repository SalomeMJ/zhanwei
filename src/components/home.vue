<template>
  <div class="home">
    <div class="top">
        ...
        <p class="scl"><span class="school">xxx学校</span></p>
        <div class="content">
          <div class="title">
